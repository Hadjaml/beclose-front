  ...
  return (
    <div className="space-y-8">
      <header className="max-w-3xl">
        ...
        <p className="mt-3 text-base leading-7 text-zinc-600">Suivez ici les onboardings et l’état des systèmes clients dès que le backend fournira ces informations.</p>
      </header>
      <ClientsEmptyState />
    </div>
  );
